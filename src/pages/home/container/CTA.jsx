  ...
  return (
    <>
      ...
      <section className="relative bg-dark-hard px-5">
        <div className="container grid grid-cols-12 mx-auto py-10 mb:pb-20 lg:place-items-center">
          <div className="col-span-12 lg:col-span-6">
            <h2 className="text-white font-roboto font-bold text-2xl md:text-4xl md:text-center md:leading-normal lg:text-left">
              Recevez des infos par e-mail chaque semaine.
            </h2>
            ...
            <p className="text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left">
              <span className="font-bold italic text-[#B3BAC5] md:not-italic md:font-normal md:text-dark-light">
                Recevez la réponse dés demain.
              </span>{' '}
              Inscrivez-vous avant 21 heures. Si la demande arrive après 21
              heures, nous répondrons le jour suivant.
            </p>
          </div>
              ...
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative">
                ...
                <div className="p-5">
                  ...
                  <p className="text-dark-light mt-3 text-sm md:text-lg">
                    Une majorité de personnes sont amenés à travailler sur des
                    emplois qui n'existent pas encore aujourd'hui.
                  </p>
                </div>
              </div>
            </div>

...
const Categories = () => {
  ...
  const {
    ...
    deleteDataMessage: "Catégorie supprimée",
  ...
  return (
    <div className="grid grid-cols-12 gap-x-4">
      <div className="col-span-4 py-8">
        <h4 className="text-lg leading-tight">Nouvelle Catégorie</h4>
      ...
      <div className="col-span-8">
        <DataTable
          ...
          searchInputPlaceholder="Titre de la catégorie..."
          searchKeywordOnSubmitHandler={submitSearchKeywordHandler}
          searchKeywordOnChangeHandler={searchKeywordHandler}
          searchKeyword={searchKeyword}
          tableHeaderTitleList={["Titre", "Créé le", ""]}
          isLoading={isLoading}
        ...
        >
          {categoriesData?.data.map((category) => (
            <tr key={category.id}>
              ...
              <td className="px-5 py-5 text-sm bg-white border-b border-gray-200">
                <p className="text-gray-900 whitespace-no-wrap">
                  {new Date(category.createdAt).toLocaleDateString("fr", {
                    day: "numeric",
                    month: "short",
                    year: "numeric",
                  })}
